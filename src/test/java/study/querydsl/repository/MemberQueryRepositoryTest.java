...
class MemberQueryRepositoryTest {
    ...
    public void basicTest() throws Exception {
        ...
        Member findMember = memberQueryRepository.findById(member.getId()).get();
        assertThat(findMember).isEqualTo(member);

        List<Member> result1 = memberQueryRepository.findAll();
        assertThat(result1).containsExactly(member);

        List<Member> result2 = memberQueryRepository.findByUsername("member1");
    ...
    public void searchTest() throws Exception {
        ...
        List<MemberTeamDto> result = memberQueryRepository.searchByBuilder(condition);
